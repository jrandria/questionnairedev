    ...
    var tpl = {
        "font-styles": function(locale, options) {
            ...
            return "<li class='btn-group'>" +
              ...
              "<i class='fa fa-font'></i>&nbsp;<span class='current-font'>" + locale.font_styles.normal + "</span>&nbsp;<span class='caret'></span>" +
              "</a>" +
        ...
        "link": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-link-modal modal hide fade' id='insert-link-modal' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'>" +
			  ...
			  "<div class='modal-content'>" +
				...
				"</div>" +
              "</div>" +
              "<a class='btn btn-default" + size + "' data-toggle='modal' data-target='#insert-link-modal' data-wysihtml5-command='createLink' title='" + locale.link.insert + "' tabindex='-1'><i class='fa fa-link'></i></a>" +
            "</li>";
        },
